...
{
    public class WindowDragger : UIBehaviour, IBeginDragHandler, IDragHandler, Core.Helpers.IHasRefToCamera
    {
        ...
        public void OnBeginDrag(PointerEventData data)
        {
            ...
            RectTransformUtility.ScreenPointToLocalPointInRectangle(DragAreaInternal, data.position, GetMyCamera(), out originalLocalPointerPosition);
        ...
        public void OnDrag(PointerEventData data)
        {
            ...
            if (RectTransformUtility.ScreenPointToLocalPointInRectangle(DragAreaInternal, data.position, GetMyCamera(), out localPointerPosition))
            {
