...
{
    [CustomEditor(typeof(WindowManager3))]
    [System.Serializable]
    public class WindowManagerEditor3 : Editor
    {
        // Variables
        private WindowManager3 wmTarget;
        private int currentTab;

        private void OnEnable()
        {
            // Set target
            wmTarget = (WindowManager3)target;
        }
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    if (wmTarget.windows.Count != 0)
                    {
                        ...
                        EditorGUILayout.PropertyField(windows, new GUIContent("Windows"), true);
                        GUILayout.Space(2);
