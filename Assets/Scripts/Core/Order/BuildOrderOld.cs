...
namespace Core.OrdersOld
{
    ...
    public class BuildOrderOld : Order
    {
        ...
        private OrderWrapper<MoveOrderOld> predecessorMoveOrderWrapper = null;
        ...
        private bool CreateAndExecuteIntermediateMoveOrder()
        {
            ...
            {
                predecessorMoveOrderWrapper = OrderFactory.CreatePredecessorOrderWrapperAndSetReceiver<MoveOrderOld>(unitWrapper, GetMyWrapper());
                
                predecessorMoveOrderWrapper.SubscribeOnClearance(() => predecessorMoveOrderWrapper = null);
                
                predecessorMoveOrderWrapper.GetWrappedAs<MoveOrderOld>().AddWaypoint(
        ...
        public BuildOrderOld()
        {
            btClock = new Clock();
            _myWrapper = new OrderWrapper<BuildOrderOld>(this, () => {_myWrapper = null;});
