...
namespace Core.OrdersOld
{
    ...
    public class EngageAtPositionsOrderOld : Order
    {
        ...
        public EngageAtPositionsOrderOld()
        {
            btClock = new Clock();
            _myWrapper = new OrderWrapper<EngageAtPositionsOrderOld>(this, () => {_myWrapper = null;});
